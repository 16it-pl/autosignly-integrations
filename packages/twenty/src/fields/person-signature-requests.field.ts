...
// The "one" side, hosted on the standard Person object.
export default defineField({
  universalIdentifier: PERSON_SR_FIELD_UNIVERSAL_IDENTIFIER,
  objectUniversalIdentifier:
    STANDARD_OBJECT_UNIVERSAL_IDENTIFIERS.person.universalIdentifier,
  type: FieldType.RELATION,
  name: 'signatureRequests',
  label: 'Signature requests',
  description: 'Documents sent for signature from this person.',
  icon: 'IconSignature',
  isNullable: true,
